...
export default async function HomePage() {
    const data: Data | undefined = {
        ...
        // Example:
        name: "Benji Wallis",
        avatar: "https://i.ibb.co/hmy7Xqs/Screenshot-2024-08-28-at-1-09-58-PM.png",
        links: [
            {
                href: "mailto:benji@benjiwallis.xyz",
                title: "benji@benjiwallis.xyz",
            },
            {
                href: "tel:+64273788527",
                title: "+64 27 378 8527",
            },
        ],
        socials: [
            {
                href: "https://github.com/bdubtga",
                title: "Github",
            },
        ],
